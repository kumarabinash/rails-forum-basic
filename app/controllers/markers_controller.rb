class MarkersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @marker.save
        format.html { redirect_to maps_path, notice: 'Marker was successfully created.' }
  ...
  private
    ...
    def marker_params
      params.require(:marker).permit(:marker_type, :lat, :lng, :title, :description, :address, :expiry_date)
    end
end
