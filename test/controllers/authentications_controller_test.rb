...
class AuthenticationsControllerTest < ActionController::TestCase
  ...
  test "should create authentication" do
    assert_difference('Authentication.count') do
      post :create, authentication: { create: @authentication.create, destroy: @authentication.destroy, index: @authentication.index }
    end
  ...
  test "should update authentication" do
    patch :update, id: @authentication, authentication: { create: @authentication.create, destroy: @authentication.destroy, index: @authentication.index }
    assert_redirected_to authentication_path(assigns(:authentication))
  end
